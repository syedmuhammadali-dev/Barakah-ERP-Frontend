...
import { LayoutDashboard, Package, ShoppingCart, BarChart3, Calculator, Users, Truck, Settings, CreditCard, LogOut } from "lucide-react";
          ...
          <Sidebar>
            <SidebarHeader className="px-4 py-6 border-b border-sidebar-border">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold tracking-tight text-sidebar-foreground">Barakah ERP</span>
              </div>
            </SidebarHeader>
            ...
            <SidebarFooter className="p-4 border-t border-sidebar-border">
              <div className="flex items-center gap-3 mb-4 px-2">
                ...
                <div className="flex flex-col overflow-hidden">
                  ...
                  <span className="text-xs text-muted-foreground truncate">{profile?.businessName || "No Business"}</span>
                </div>
              </div>
              <button 
                onClick={() => logout()}

    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-primary-foreground font-bold text-2xl shadow-lg shadow-primary/30">
            B
          </div>
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          {STEPS.map((s, i) => (
            <div key={s.id} className="flex items-center gap-2">
              ...
              <span
                className={`text-sm font-medium hidden sm:block ${step === s.id ? "text-foreground" : "text-muted-foreground"}`}
              >
                {s.label}
              </span>
              {i < STEPS.length - 1 && (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Standard rate in Pakistan is 0% for most small retailers
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-muted/40 rounded-xl border border-border">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Enables Zakat calculation, Sharia compliance tracking, and
                      Amanat management
                    </p>
                  </div>
                  <Switch
                    checked={form.islamicModeEnabled}
                    onCheckedChange={(v) =>
                      setForm((f) => ({ ...f, islamicModeEnabled: v }))
                    }
                  />
                </div>
                  ...
                  {[
                    {
                      icon: Package,
                      title: "Inventory",
                      desc: "Track stock, SKUs & barcodes",
                    },
                    {
                      icon: ShoppingCart,
                      title: "Sales",
                      desc: "Invoice & ledger management",
                    },
                    {
                      icon: Calculator,
                      title: "Zakat",
                      desc: "Auto Sharia compliance",
                    },
                    {
                      icon: Building2,
                      title: "Suppliers",
                      desc: "Returns & balance ledger",
                    },
                    {
                      icon: BarChart3,
                      title: "Reports",
                      desc: "Revenue & growth charts",
                    },
                    {
                      icon: Clock,
                      title: "Salesmen",
                      desc: "Targets & commissions",
                    },
